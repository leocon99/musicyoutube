...
const apiKeyList = ["AIzaSyD2GXkl_gCOA15T6YT_SKd6e9s3zibN7RU", "AIzaSyAvPUsjjqCxjx9ZlIZh-EcdiBAFbJOeoO0", "AIzaSyB56E3cgBh0TMpNi5WQJT9AMFtChFIeEIo"];
...
getPlayListItems("PLFHK5Y9u3K2NVtvpS8YzEBAhM-nDW3mty")
.then(data => {
	data.forEach(item => {
